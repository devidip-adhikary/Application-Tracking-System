...
export const metadata: Metadata = {
  title: "Next.js SignUp Page | TapzAdmin - Next.js Dashboard Template",
  description: "This is Next.js SignUp Page TapzAdmin Dashboard Template",
  // other metadata
};
