...
const create_default_users = async () => {
  try {
    const defaultUsers = [
      { name: "Devidip Adhikary", email: "devidip.adhikary@protivitiglobal.in", role: "admin", password: "pro@1234" },
      { name: "Sarbajit Chakraborty", email: "sarbajit.c@protivitiglobal.in", role: "admin", password: "pro@1234" },
      { name: "Abhirup Roy", email: "abhirup.roy@protivitiglobal.in", role: "admin", password: "pro@1234" },
    ];
